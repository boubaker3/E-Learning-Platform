      ...
      <div class="w-full flex">
        <div class="w-12 w-h rounded items-center flex justify-center p-2">
          <img
            ...
            :src="photoPath == null ? userDefault : photoPath"
          />
        </div>
    ...
    <div class="md:flex mt-4">
      <div class="w-1/2">
          ...
          <div class="controls">
            <button @click="togglePlay">
              <i
                :class="
                  isPlaying
                    ? 'fa fa-pause text-primary-variant'
                    : 'fa fa-play text-primary-variant'
                "
              ></i>
            </button>
            <input
        ...
        <div class="mt-2 text-texts text-sm font-bold">
          ...
          <h1 class="text-primary-variant text-base lg:text-lg xl:text-xl">
            Course Details:
          </h1>

          <h2 class="text-base lg:text-lg xl:text-xl mt-6">
            What you're gonna learn:
          </h2>
          <div
            v-for="benefit in benefits"
            class="bg-inputs w-full p-2 rounded-md mt-4"
          >
      ...
      <div class="w-1/2 ml-4 bg-secondary rounded-lg h-auto p-4">
        <div
          ...
          class="text-texts items-center flex"
        >
          <h1>{{ index + 1 }}.</h1>
...
export default {
  ...
  mounted() {
    ...
    store.dispatch("getUserdata", this.$route.params.userid, false);
    ...
    api
      ...
      .then((response) => {
        ...
        api
          .get(`viewVideo?videoid=${this.videoid}`, {
            responseType: "blob",
          })
          .then((response) => {
