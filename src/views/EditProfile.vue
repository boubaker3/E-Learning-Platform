    ...
    <form @submit.prevent="updateProfile">
      <div class="mb-6">
        ...
        <input
          ...
          type="text"
          id="fullname"
          class="shadow-sm bg-inputs text-texts text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full md:w-1/4 p-2.5"
      ...
      <div class="mb-6">
        ...
        <input
          ...
          v-model="email"
          id="email"
          class="opacity-50 shadow-sm bg-inputs text-texts text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full md:w-1/4 p-2.5"
      ...
      <input
        v-model="facebook"
        class="shadow-sm mb-2 bg-inputs text-texts text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full md:w-1/4 p-2.5"
      ...
      <button
        type="submit"
        class="text-texts hover:text-gray-800 px-4 py-2 bg-primary-variant ml-2 rounded p-2 mt-2"
      >
        Update Profile
      </button>
    </form>
...
export default {
  ...
  methods: {
    updateProfile() {
      if (this.fullname.length < 8) {
        ...
        if (this.oldPassword.length < 8 || this.newPassword.length < 8) {
          ...
          api
            .post(`updateProfile?userid=${this.userid}`, {
    ...
    updatePhoto() {
      ...
      api
        .post(`updatePhoto?userid=${this.userid}`, formData)
        .then((response) => {
