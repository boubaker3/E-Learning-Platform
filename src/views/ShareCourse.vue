<template>
  <div class="p-2">
    <form @submit.prevent="share" enctype="multipart/form-data">
      <h1 class="text-texts text-sm md:text-base lg:text-lg xl:text-xl">
        Share A Course
      </h1>
      <br />
      <h1
        class="text-texts text-sm md:text-base lg:text-lg xl:text-xl flex items-center justify-center"
      >
        course info
      </h1>
      ...
      <label for="coursethumb">
        <div
          class="w-full md:w-1/2 h-72 rounded-xl bg-secondary items-center justify-center flex"
        >
          <img
            v-if="courseThumb"
            :src="courseThumb"
          ...
          <img
            ...
            "
            v-if="!courseThumb"
            src="../assets/image_holder.png"
            class="w-1/4 h-auto object-cover opacity-50 rounded-xl"
          />
      ...
      <div class="mb-6">
        <label
          for="title"
          class="block mb-2 text-sm font-medium text-gray-900 text-texts"
          >course title</label
        >
        <input
          v-model="title"
          type="text"
          id="title"
          class="shadow-sm bg-inputs text-texts text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full md:w-1/4 p-2.5"
          placeholder="example: learn html5"
        />
      </div>
      ...
      <div class="mb-6">
        <div
          ...
          class="bg-inputs w-1/4 p-2 rounded-md mt-4"
        >
        ...
        <input
          ...
          id="benefit"
          class="shadow-sm bg-inputs text-texts text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full md:w-1/4 p-2.5"
          placeholder="what it takes to start this course?"
        />
        <br />
        <button
          :disabled="benefits.length > 20"
          @click="addBenefit"
          class="text-texts hover:text-gray-800 px-4 py-2 bg-inputs ml-2 font-bold rounded"
        >
          add benefit
        </button>
      </div>
      ...
      <div class="mb-6">
        <div
          ...
          class="bg-primary-variant w-1/4 p-2 rounded-md mt-4"
        >
        ...
        <button
          ...
          @click="addReq"
          class="text-texts hover:text-gray-800 px-4 py-2 bg-primary-variant ml-2 font-bold rounded"
        >
          add requirement
        </button>
      </div>
      <div class="mb-6">
        ...
        <select
          v-model="category"
          class="w-1/4 outline-0 bg-secondary text-texts p-2 rounded-md"
          id="categories"
        >
      ...
      <div v-if="paid_or_free == 'paid'" class="mb-6">
        ...
        <input
          ...
          id="title"
          class="shadow-sm bg-inputs text-texts text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full md:w-1/4 p-2.5"
          placeholder="whats the price in $"
        />
      </div>
      <h1
        class="text-texts text-sm md:text-base lg:text-lg xl:text-xl flex items-center justify-center"
      ...
      <div>
        <div
          class="text-texts text-sm md:text-base flex items-center justify-center"
        ...
        <div class="flex w-full text-texts font-bold">
          <label for="addvideo"
            ><i
              class="fas fa-add hover:text-gray-800 px-4 py-2 bg-primary-variant ml-2 rounded"
            ></i
          ></label>
